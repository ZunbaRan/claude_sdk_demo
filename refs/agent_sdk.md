...
## Authorization
Allow to authenticate with Claude Code SDK in same manner as Claude Code using environmental setup with ANTHROPIC_AUTH_TOKEN, ANTHROPIC_MODEL, ANTHROPIC_SMALL_FAST_MODEL, ANTHROPIC_BASE_URL.

You can pass them as part of the ClaudeAgentOptions env parameter
```python
